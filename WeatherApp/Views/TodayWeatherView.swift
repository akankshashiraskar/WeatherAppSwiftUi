    ...
    var body: some View {
        VStack(spacing: 10) {
            Text("Today")
                ...
                .bold()
            HStack(spacing: 20){
                LottieView(name: cityVM.getLotteiAnimationFor(icon: cityVM.weatherIcon))
             ...
             HStack {
                 Spacer()
                        ...
                        Spacer()
                               widgetView(image: "drop.fill", color: .blue, title: "\(cityVM.humidity)mi/hr")
                        Spacer()
                               widgetView(image: "umbrella.fill", color: .red, title: "\(cityVM.rainchances)mi/hr")
                        spacer()
